...
const data = {
  branch: {
    id: "monirampur",
    name: "Dream Health and Information Technology - Monirampur Branch",
    shortName: "DHIT Monirampur",
    tagline: "মনিরামপুর শাখা যেখানে পেশাদার স্বাস্থ্য ও তথ্য প্রযুক্তি প্রশিক্ষণের নিশ্চয়তfulness রয়েছে",
    govtApproved: true,
    govtRegNo: "সি-১৭০২২৯/২১",
    approvalNote: "গণপ্রজাতন্ত্রী বাংলাদেশ সরকার কর্তৃক অনুমোদিত এবং স্বাস্থ্য অধিদপ্তরের কারিকুলাম অনুসারে",
    govtRegNoShort: "সি-১৭০২২৯",
  },
  director: {
    name: "Director (DHIT Monirampur)",
    designation: "Director (DHIT Monirampur)",
    email: "monirampur@dhitedu.info",
    phonePrimary: "01XXXXXXXXX",
    phoneSecondary: [],
  },
  contact: {
    address: "মনিরামপুর, ঝিনাইদহ, বাংলাদেশ",
    addressEn: "Monirampur, Jhenaidah, Bangladesh",
    district: "Jhenaidah",
    phones: ["01XXXXXXXXX"],
    email: "monirampur@dhitedu.info",
  },
  ...
  seo: {
    slug: "monirampur",
    metaTitle: "DHIT Monirampur Branch - Dream Health and Information Technology",
    metaDescription: "DHIT Monirampur Branch. Govt approved paramedical courses including RMP, DMA, DMF, Dental & Nursing. Admission going on.",
  },
};

export const metadata = {
  title: "মনিরামপুর শাখা | DHIT - Dream Health & Information Technology",
  description: "DHIT মনিরামপুর শাখার পেশাদার স্বাস্থ্য ও তথ্য প্রযুক্তি কোর্সসমূহ। ভর্তি চলছে।",
  openGraph: {
    title: "DHIT Monirampur Branch",
    description: "Medical Assistant, Paramedical & Nursing Courses at Monirampur Branch.",
  },
};
